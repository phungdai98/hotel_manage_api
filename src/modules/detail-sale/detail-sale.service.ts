...
export class DetailSaleService {
  ...
  async create(
    createDetailSaleDto: CreateDetailSaleDto,
    ...
    try {
      ...
      return new ApiResponse(
        true,
        null,
        `Create detail sale successfully`,
        200,
      );
    } catch (error) {
  ...
  async findAll(): Promise<DetailSaleResponse[]> {
    try {
      ...
      return detailSales.map(
        (detailSale) => new DetailSaleResponse(detailSale),
      );
    } catch (error) {
      throw new InternalServerErrorException((error as Error).message);
    }
  ...
  async update(
    id: string,
    updateDetailSaleDto: UpdateDetailSaleDto,
  ): Promise<ApiResponse<null>> {
    try {
      const detailSale = await this.detailSaleRepository.findOne({
        where: { id },
      ...
      return new ApiResponse(
        true,
        null,
        `Update detail ${id} sale successfully`,
        200,
      );
    } catch (error) {
      throw new InternalServerErrorException((error as Error).message);
  ...
  async remove(id: string): Promise<ApiResponse<null>> {
    try {
      ...
      return new ApiResponse(
        true,
        null,
        `Delete detail ${id} sale successfully`,
        200,
      );
    } catch (error) {
      throw new InternalServerErrorException((error as Error).message);
